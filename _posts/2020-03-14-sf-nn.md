...
The install dir for gym is two folders back from where you put the rom; /retro and put the ui exe there. DL from [here](https://github.com/onecloudemoji/onecloudemoji.github.io/blob/master/assets/images/sf-nn/Gym%20Retro%20Integration.7z), because the link in the official docs isn’t working. I normally would send you off on a chase to retrieve it yourself, but I actually can’t find it anywhere! 
